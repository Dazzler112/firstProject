			...
			<div class="col-12 col-md-8 col-lg-6">
				...
				<form method="post">
					...
					<div class="mb-3">
						...
						<input id="writerInput" class="form-control" type="text" name="title" value="${adBoard.writer }" />
					</div>
					<div class="mb-3">
						<label for="regionInput" class="form-label">지역</label>
						<input id="regionInput" class="form-control" type="text" name="title" value="${adBoard.region }" />
					</div>
					<div>
