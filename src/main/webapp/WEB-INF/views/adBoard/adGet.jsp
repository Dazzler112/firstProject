...
<body>
				...
				<div class="me-auto">
					...
					<div>
						...
						<div class="mb-3">
							...
							<input type="text" class="form-control" value="${adBoard.region }" readonly />
						</div>
						<div class="mb-3">
						...
						<div>
							<a class="btn btn-secondary" href="/adBoard/adModify/${adBoard.id }">수정</a>
	...
	<div class="d-none">
		<form action="/adBoard/adRemove" method="post" id="removeForm">
			<input type="text" name="id" value="${adBoard.id }" />
		</form>
	</div>
