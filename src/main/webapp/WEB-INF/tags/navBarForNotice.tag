...
<%
      String link = "http://localhost:8084/SecondStop/list4";
   %>
   ...
   <header class="header">
      <div class="header__wrapper">
         ...
         <div class="header__start">
            <sec:authorize access="isAnonymous()">
               <span class="header__title"><a class="linkcolor" href="/SecondStop/list1">
                     <img class="navbarimage" src="/img/navbarimage.png" alt="My Image" />
                  </a> </span>
            </sec:authorize>
            <sec:authorize access="isAuthenticated()">
               <a class="linkcolor" href="/SecondStop/list2">
                  <img class="navbarimage" src="/img/navbarimage.png" alt="My Image" />
               </a>
            </sec:authorize>
         </div>
         ...
         <div id="dropdown" class="btn-toggle btn-secondary">
            ...
            <ul class="dropdown-menu" id="dropdownMenu">
               ...
               <sec:authorize access="isAuthenticated() and !hasAuthority('admin')">
                  <li>
                     <button class="dropdown-item" type="button">
                        <a class="linkcolor"  class="linkcolor"  href="/member/info?id=<sec:authentication property="name" />">마이페이지</a>
                     </button>
                  </li>
               </sec:authorize>
      ...
      <nav id="primary_nav_wrap">
         <ul>
            ...
            <li><a href="http://localhost:8084/SecondStop/list4">카테고리</a>
               <ul>
                  <li><a onClick="location.href='<%=link%>?search=패션'">패션</a></li>
                  <li><a onClick="location.href='<%=link%>?search=패션'">가구</a></li>
                  <li><a onClick="location.href='<%=link%>?search=패션'">게임</a></li>
                  <li><a onClick="location.href='<%=link%>?search=패션'">명품</a></li>
                  <li><a onClick="location.href='<%=link%>?search=패션'">전자기기</a></li>                  
                  <li><a onClick="location.href='<%=link%>?search=패션'">게임</a></li>
                  <li><a onClick="location.href='<%=link%>?search=패션'">무료나눔</a></li>
               </ul></li>
            <li><a href="#">게시판</a>
               <ul>
