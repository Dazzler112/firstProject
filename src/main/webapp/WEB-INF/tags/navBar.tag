		...
		<div class="header__wrapper">
			...
			<div class="header__start">
				...
				<img style="width: 100px; height: 70px;" class="navbarimage" src="/img/navbarimage.png"
					alt="My Image">
				<sec:authorize access="isAnonymous()"> <!-- 로그인 안되어 있을때 -->
					<span class="header__title"><a class="linkcolor" href="/teamProject/list1">SecondStop</a></span>
				</sec:authorize>
				<sec:authorize access="isAuthenticated()"> <!-- 로그인 하였을때 -->
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<button type="button"  data-bs-dismiss="modal" aria-label="Close" style="border: 0 solid black;"><i class="fa-solid fa-magnifying-glass"></i></button>
					</div>
