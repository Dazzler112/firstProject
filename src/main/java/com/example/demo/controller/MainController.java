...
public class MainController {
   ...
   public String exList(Model model,
           @RequestParam(value = "statusCode", defaultValue = "") String statusCode,
           @RequestParam(value = "title", defaultValue = "") String title,
           @RequestParam(value = "inserted", defaultValue = "") LocalDateTime inserted,
           @RequestParam(value = "body", defaultValue = "") String body,
           @RequestParam(value = "writer", defaultValue = "") String writer,
           ...
           @RequestParam(value = "likes", defaultValue = "") Integer likes,
           @RequestParam(value = "modi", defaultValue = "") String modi,
           @RequestParam(value = "memberId", defaultValue = "") String memberId,
           @RequestParam(value = "ProductID", defaultValue = "") Integer ProductID) {

       List<Product> exList = service.exList(statusCode, title, inserted, body, writer, price, views, likes, modi, memberId, ProductID);
...
/*   @GetMapping("/id/{id}")
    public String get(@PathVariable("id") Integer id, Model model, Authentication authentication) {
        ...
        model.addAttribute("exList", product);
        return "exList";
    }

    // getProductById() 메소드 추가
    public Product getProductById(Integer id) {
        // 상품 정보를 가져와서 Product 객체로 생성
        Product product = // 상품 정보를 가져오는 로직
