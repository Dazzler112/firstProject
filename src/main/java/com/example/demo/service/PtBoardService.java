...
public class PtBoardService {
	...
	public boolean modify(PtBoard board, MultipartFile[] addFiles, List<String> removeFileNames) throws Exception{
	...
	public boolean addBoard(PtBoard board, MultipartFile[] files) throws Exception {
